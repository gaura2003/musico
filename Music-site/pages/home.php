        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                <li class="nav-item active">
                    <a class="nav-title" href="profile.php">Profile</a>
                </li>
                <li class="nav-item">
  <a class="nav-title" href="">Artists</a>
                </li>
                <li class="nav-item">
                    <a class="nav-title" href="#">Category</a>
                </li>
                                <li class="nav-item">
                    <a class="nav-title" href="../Trim Songs/index.html">Ringtones</a>
                </li>
                 <li class="nav-item">
  <a class="nav-title" href="upload music.php">Upload Music</a>
                <li class="nav-item">
                    <a class="nav-title" href="login.php">Logout</a>
                </li>
            </ul>
        </div>
    </nav>   
